...
fn rust_process_float(_cr: &OCamlRuntime, input_float: f64) -> f64 {
...
#[ocaml_interop::export(noalloc)]
fn rust_process_int64(_cr: &OCamlRuntime, input_i64: i64) -> i64 {
...
// Example with bool
#[ocaml_interop::export(noalloc)]
fn rust_process_bool(_cr: &OCamlRuntime, input_bool: bool) -> bool {
...
#[ocaml_interop::export(noalloc)]
fn rust_process_unit_to_unit(_cr: &OCamlRuntime, _input_unit: OCaml<()>) {
...
#[ocaml_interop::export(noalloc)]
fn rust_process_isize(_cr: &OCamlRuntime, input_isize: isize) -> isize {
...
#[ocaml_interop::export(noalloc)]
fn rust_process_i32(_cr: &OCamlRuntime, input_i32: i32) -> i32 {
    println!("[Rust] rust_process_i32 received: {}", input_i32);
    input_i32 * 2
}

#[ocaml_interop::export(noalloc)]
fn rust_combine_primitives_noalloc(_cr: &OCamlRuntime, f: f64, i: i64, b: bool) -> i64 {
    println!(
...
#[ocaml_interop::export(noalloc)]
fn rust_select_i64_noalloc(_cr: &OCamlRuntime, f: f64, i: i64, b: bool) -> i64 {
...
#[ocaml_interop::export(noalloc)]
fn rust_log_primitives_noalloc(_cr: &OCamlRuntime, f: f64, i: i64, b: bool) {
    println!(
